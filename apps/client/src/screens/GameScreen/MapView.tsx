...
import { MAP_EDGES, MAP_NODES, getMapNode } from '@sam-simul/shared';
    ...
    <div className="card">
      ...
      <svg viewBox="0 0 700 600" className="map-svg" role="img" aria-label="삼국지 지도">
        ...
        {armies.map((army) => {
          ...
          return <circle key={army.armyId} cx={x} cy={y} r={5} fill={ownerColor(army.ownerId)} stroke="#000" strokeWidth={0.5} className="map-army-marker" />;
        })}
